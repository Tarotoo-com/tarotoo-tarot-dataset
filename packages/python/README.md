...
Each card has: `id`, `name`, `arcana`, `suit`, `number`, `element`, `astrology`, `numerology`, `primary_color`, `yes_no`, `keywords_upright`, `keywords_reversed`, `meaning_upright`, `meaning_reversed`, `love`, `career`, `mood`, `spiritual`, `url`.
