...
REQUIRED_FIELDS = [
    "id", "name", "arcana", "suit", "number", "element", "astrology",
    "yes_no", "keywords_upright", "keywords_reversed",
    "meaning_upright", "meaning_reversed", "love", "career",
]
...
def validate(cards):
    ...
    for card in cards:
        ...
        for text_field in ("meaning_upright", "meaning_reversed", "love", "career"):
