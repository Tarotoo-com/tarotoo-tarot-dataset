...
REQUIRED_FIELDS = [
    "id", "name", "arcana", "suit", "number_numerology", "element", "planet", "zodiac", "primary_color",
...
def validate(cards):
    ...
    for card in cards:
        ...
        for text_field in ("meaning_upright", "meaning_reversed", "love", "career", "mood", "spiritual", "url", "primary_color"):
